...
export default class OnboardingScreens extends Component {
  ...
  initState(props) {
    ...
    // and not state to avoid comp re-renders when updated
    this.internals = {
      isScrolling: false,
      offset
    };
  ...
  swipe = () => {
    ...
    // Call scrollTo on scrollView comp to perform the swipe
