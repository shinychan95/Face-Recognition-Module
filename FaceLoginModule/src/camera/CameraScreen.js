...
export default class CameraScreen extends React.Component {
    ...
    facesDetected({ faces }) {
        ...
        this.setState((state) => {
            return {saveNumber: state.saveNumber + 1};
        });
        if(this.state.saveNumber < 10) {
            this.takePicture() } else {
            alert("Over the 10")
            this.toggle('canDetectFaces')
        }
        this.setState({ faces })
    }
    ...
    renderCamera() {
        ...
        return (
            <RNCamera
                ...
                onFacesDetected={ face => { canDetectFaces ? this.facesDetected(face) : null }}
